		...
		<div class="container">
					...
					<li class="splash">
						<a href="#information">
							<div class="profile-image">
								<img src="<?php echo $personaldetails['image']; ?>"height="150",width="150" />
							</div>
			...
			<section id="profile">
				...
				<article class="profile-buttons">
					<button class="download"><a href="/Resume-Buiderr/Resume/" download="index.php">Download</button>
			...
			<footer id="footer">
				<a href="#" id="toTop"></a>
				COPYRIGHT &copy; 2013 - Resume Builder ALL RIGHTS RESERVED.
			</footer>
		</div>
		<?php
